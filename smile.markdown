...
# Flags
List of emojis for country flags. 🇯🇵 🇰🇷 🇩🇪 🇨🇳 🇺🇸 🇫🇷 🇪🇸 🇮🇹 🇷🇺 🇬🇧 Emoji flags are supported on most major platforms, except Windows which displays two-letter country codes instead of emoji flag images.

The emoji flag list is based on ISO 3166-1: a list of internationally recognized two-letter country codes. Subdivision flags for England, Scotland and Wales are included as part of Emoji 5.0.
